  ...
  createData("Fiverr", "Freelancer", [
    {
      ...
      responsibilties: [
        ...
        "Integrate third-party APIs and services to enhance application functionality Optimize the website's design and functionality to improve the conversion rate. Accomplished a 10% increase in the conversion rate for the website. ",
        "Implement measures to decrease the bounce rate, which is the percentage of visitors who leave the website after viewing only one page. Reduced the bounce rate by 15% of the website. ",
  ...
  createData("DXC Technology", "Software Engineer", [
    {
      ...
      responsibilties: [
        ...
        "Conduct code reviews and provide constructive feedback to team members Successfully reduced the response time of the application to be loaded by 30% and improved overall performance and interactivity of the application. ",
        ...
        "Improve search engine ranking: Implement SEO strategies to enhance the website's visibility in search engine results. Achieved a 20% increase in organic search traffic .",
        "Implement measures to minimize website downtime and ensure maximum uptime. Achieved 99.9% uptime of the website for a year .",
        "Collaborate with cross-functional teams to gather and analyze user requirements Participate in software development life cycle activities such as requirement analysis, design, and implementation. ",
